...
import (
	...
	app_webhooks "github.com/GoogleCloudPlatform/anthos-appconfig/appconfigmgrv2/api/webhooks"
...
func init() {
	...
	appconfigmgrv1alpha1.AddToScheme(scheme)
...
func main() {
	...
	app_webhooks.SetupWebHooks(mgr)
